...
Architecture guidance for LocalStack-based AWS emulation. Delegates CLI operations to `aws-localstack` and `aws-local` skills.
...
- For CLI commands: use `aws-localstack` skill
- For AWS CLI commands: use `aws-local` skill
