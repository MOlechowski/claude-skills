...
Generate directory trees using the system `cli-tree` command.

## Prerequisites

Requires `cli-tree` command installed:
...
If `cli-tree` is not installed, the command will fail. Install it using the instructions above.
