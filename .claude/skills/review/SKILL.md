...
→ Delegate to `review-pr` in diff mode. Prefer staged changes if both exist.
...
Delegate entirely. Do not perform the review yourself. Do not add your own scoring or summary on top of the sub-skill output.

## Sub-skills

| Skill | Purpose |
|-------|---------|
| `review-file` | Static code analysis of files and directories |
| `review-pr` | Change-focused review of diffs and GitHub PRs |
